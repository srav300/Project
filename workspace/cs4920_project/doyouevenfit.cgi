...
<h2 align="right"><form action="doyouevenfit.cgi" method="post">
  <input type="hidden" name="page" value="">
<input type="submit" name="update" value="MESSAGE" class="btnBlink"">
<input type="submit" name="update" value="UPDATE PROFILE" class="button_small"">
...
<div class="container">
    <div class="column-left"><h style="text-align:right;border:1px;solid:#ffffff;background-color:rgba(255,255,255,0);color:white;font-size:22pt;height:40px;width:200px;font-family:AmbleRegular;"value="&#8656"><br></div>
  ...
  $output .= qq(
<input type="submit" name="change_date" value="" class="button_hide" style="height:0px;width;0px;">);
  $output .= qq(<p>&nbsp</p>
  <p>&nbsp</p>);
